...
const ACTION_COLORS: Record<string, string> = {
  ...
  TABLE_CREATED: "bg-amber-50 text-amber-800 dark:bg-amber-900/30 dark:text-amber-400",
  INVITE_CREATED: "bg-stone-100 text-stone-700 dark:bg-stone-900/30 dark:text-stone-400",
